...
A small browser-based music and ear-training tool for practicing pitch, intonation, tuning, rhythm, and frequency recognition using the Web Audio API.

Live demo: [https://p.jeltz.org/](https://p.jeltz.org/)
...
The Tuning tab can play a selected reference note, detect live pitches through the microphone, or do both at the same time.

## Files

- `index.html` - interface and application metadata
- `index.css` - styles and responsive layout
- `index.js` - audio, microphone pitch detection, metronome, exercises, and application logic
...
Pitch Playground is licensed under the [GNU General Public License v3.0](https://www.gnu.org/licenses/gpl-3.0.en.html) or later.
